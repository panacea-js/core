 ...
 * @returns object
 */
EntityTypes.prototype.convertFieldTypeToMongo = function (type) {
 ...
 * @returns String
 */
EntityTypes.prototype.convertFieldTypeToGraphQL = function (type) {
    if (typeof type !== 'string' || type === '') {
...
EntityTypes.prototype.addError = function (entityTypeData, error) {
    // Ensure the _errors array exists.
    entityTypeData._errors = entityTypeData._errors || [];
    entityTypeData._errors.push(error);
};
EntityTypes.prototype.validate = function (entityTypeData, entityTypeName, action) {
...
EntityTypes.prototype.addMeta = function (entityTypeData, entityTypeName) {
...
EntityTypes.prototype.addFieldsMeta = function (fields) {
...
EntityTypes.prototype.clearCache = function () {
    this.definitions = {};
    this.fieldTypes = {};
    this.fieldsMapMongo = new Map();
    this.fieldsMapGraphQL = new Map();
};
EntityTypes.prototype.getData = function () {
...
EntityTypes.prototype.save = function (name, data, locationKey) {
    const result = {
        success: false,
        errorMessage: ''
    };
...
EntityTypes.prototype.stripMeta = function (data) {
...
EntityTypes.prototype.removeFalsyFields = function (fields) {
    _(fields).forEach((field, fieldName) => {
 ...
 * @private
 */
function checkObjectsHaveFields(fields, entityTypeName) {
 ...
 * @private
 */
function validateRequiredProperties(entityTypeData, entityTypeName, action) {
 ...
 * @private
 */
function validateRequiredFields(entityTypeData, entityTypeName, action, fields) {
    _(fields).forEach((field, fieldName) => {
